...
export const useService = () => {
  ...
  const gotoImauth2 = (jobid, s, uri,empid) => {
    let state = btoa(`approve2|${jobid}|${s}|${uri}|${empid}`);
    // window.location.href =
    ...
    //   state;
    window.location.href =
      "https://imauth.bora.dopa.go.th/api/v2/oauth2/auth/?response_type=code&client_id=TGFNQU56RDNMcDRrWDRlNHhEUHNLNVNLOE8waU5wZ1Y=&redirect_uri=https://www.controldata.co.th/mpsicc/ddopa&scope=pid%20name&state=" +
      state;
  };
